...
<body>
   <div class="wrapper">
      ...
      <div id="content">
         ...
         <form action="bn_Invoice_Manage.php" method="post" enctype="multipart/form-data" id="form1">
            <h2> แก้ไขใบชำระเงิน </h2>
            ...
            <input id="" name="" class="form-control" value="<?php echo   $rowpro['Queue_Mechanic_name']; ?>" disabled>

            <label class="form-text">ทะเบียนรถ</label>
            <input id="" name="" class="form-control" value="<?php echo  $rowpro['Queue_plate_car']; ?>" disabled>
            ...
            <input id="Invoice_found_problem" name="Invoice_found_problem" class="form-control" placeholder="ปัญหาที่ช่างพบ" REQUIRED>

            <label class="form-text">ค่าใช้จ่ายรวม</label>
            <input id="Invoice_cost" name="Invoice_cost" class="form-control" REQUIRED>

            <label class="form-text">วันที่สิ้นสุดการชำระหนี้</label>
            <input id="Invoice_end" name="Invoice_end" type="date" class="form-control" REQUIRED>
